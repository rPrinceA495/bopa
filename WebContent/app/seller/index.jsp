          	...
          	<div class="row mt">
          		...
          		<!-- WHITE PANEL - TOP USER -->
							<div class="white-panel pn">
								...
								<p><img src="${ seller.profilePic }" class="img-circle" width="80"></p>
          		...
          		<div class="col-md-12">
						...
						<div class="white-panel pn">
								...
								<div class="row">
	                      		...
	                      		<div class="centered">
										<img src="../assets/img/marijuana-3678222_1280.jpg" width="120">
	                      		</div>
                      		</div>
                      		...
                      		<div class="white-panel pn">
								...
								<div class="row">
									<div class="col-sm-6 col-xs-6 goleft">
										<p>2. Prescribed pharmaceuticals</p>
									</div>
									<div class="col-sm-6 col-xs-6"></div>
	                      		</div>
	                      		<div class="centered">
										<img src="../assets/img/pills-384846_1280.jpg" width="120">
	                      		</div>
                      		</div>
                      		...
                      		<div class="white-panel pn">
								...
								<div class="row">
	                      		...
	                      		<div class="centered">
										<img src="../assets/img/smith-and-wesson-938834_1280.png" width="120">
	                      		</div>
                      		</div>
						  ...
						  <div class="modal-dialog">
						    <div class="modal-content">
						      ...
						      <div class="modal-body">
						        ...
						        <form id="editProfile" class="form-horizontal style-form" action="../../EditSellerServlet" method="post" enctype="multipart/form-data">
									
									
		                          		<div class="form-group">
		                              		<label class="col-sm-2 col-sm-2 control-label">First Name</label>
				                        	<div class="col-sm-10">
				                        		<input type="text" name="firstName" id="firstName" class="form-control" value="${seller.firstName }" required>
				                        	</div>
		                          		</div>
		                          		<div class="form-group">
		                              		<label class="col-sm-2 col-sm-2 control-label">Last Name</label>
				                        	<div class="col-sm-10">
				                        		<input type="text" name="lastName" id="lastName" class="form-control" value="${seller.lastName }" required>
				                        	</div>
		                          		</div>
										...
										<div class="form-group">
		                              		...
		                              		<c:if test="${seller.gender == 'M'.charAt(0)}">
		                              		...
		                              		<c:if test="${seller.gender == 'F'.charAt(0)}">
		                              			<label style="margin-left:20px;">
		                              				Male
		                          		...
		                          		<div class="form-group">
				                        	...
				                        	<div class="col-sm-10">
				                        		<input type="text" name="oomangNo" id="oomangNo" class="form-control" value="${seller.oomangNo }" required>
				                        	</div>
		                          		</div>
		                          		<div class="form-group">
		                              		<label class="col-sm-2 col-sm-2 control-label">Contact Number</label>
				                        	<div class="col-sm-10">
				                        		<input type="number" name="contactNo" id="contactNo" class="form-control" value="${seller.contactNo }" required>
				                        	</div>
		                          		</div>
		                          		<div class="form-group">
		                              		<label class="col-sm-2 col-sm-2 control-label">Date of Birth</label>
				                        	<div class="col-sm-10">
				                        		<input type="date" name="dob" id="dob" class="form-control" value="${seller.dob }" required>
				                        	</div>
		                          		</div>
		                          		...
		                          		<div class="form-group">
				                        	...
				                        	<div class="col-sm-10">
				                        		<textarea rows="3" class="form-control" name="postalAddress" id="postalAddress"  autofocus required>${seller.postalAddress }</textarea>
				                        	</div>
		                          		</div>
		                          		...
		                          		<div class="form-group">
				                        	...
				                        	<div class="col-sm-10">
				                        		<input type="email" name="emailAddress" id="disabledInput" class="form-control" value="${seller.emailAddress }" disabled>				                        		
				                        	</div>
		                          		</div>
						  ...
						  <div class="modal-dialog">
						    <div class="modal-content">
						      ...
						      <div class="modal-body">
									...
									<form id="editPassword" class="form-horizontal style-form" action="../../changePassword" method="post">
